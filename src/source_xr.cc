...
void XR_Device::initialize()
{
    ...
    double std = (10.5/100.0)*mean;                             // 10.5 % of mean
    ...
    //EV << "[srcXR] frame size = " << frameSize << " and current time = " << simTime() << endl;
...
ethPacket *XR_Device::generateNewPacket()
{
    ...
    //EV << "[srcXR] New packet generated with size (bytes): " << pkt_size << endl;
    return pkt;
}
